<?php
class Lawnchair_s3 extends Lawnchair_Adapter{
	public $s3;
	public $bucket;
	public function __construct($awsAccessKey,$awsSecretKey,$bucket){
	...
	function write($file,$data){
		$fileName = $file.".json";
		if ($this->s3->putObjectString($data, $this->bucket, $fileName, S3::ACL_PUBLIC_READ)) {
			//	echo "http://".$this->bucket.".s3.amazonaws.com/".$fileName;
			return true;
		}else{
			return false;
//			die("could not save");
